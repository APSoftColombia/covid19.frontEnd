        ...
        <v-col cols="12">
            <v-card outlined tile>
                <v-card-text class="text-justify">
                  <v-subheader class="title">Infección Respiratoria Aguda Grave o Enfermedad por Coronavirus - COVID grave</v-subheader>
                  Persona con <u><strong>al menos uno de los siguientes síntomas</strong></u>: fiebre cuantificada mayor o igual a 38 °C, tos, dificultad respiratoria, odinofagia, fatiga/astenia, anosmia o hipogeusia <u><strong>que requiera hospitalización</strong></u>, y que cumpla <u><strong>con al menos una de las siguientes condiciones</strong></u>:
                    <br/>
                    <br/>
                  <ul>
                    <li>
