		...
		<template v-else>
			...
			<v-content>
				<v-expand-transition>
					...
					>
						<v-row align="center">
							<v-col class="grow py-0" v-if="esMovil">Se requiere cerrar y abrir el navegador, luego realizar la descarga de ajustes generales.</v-col>
							<v-col class="grow py-0" v-else>Se requiere comando CTRL+F5 y realizar la descarga de ajustes generales.</v-col>
...
export default {
  ...
  computed: {
	...
	beforeCreate() {
		...
		console.log('this.getF5', this.rF5)
	},
	created() {
	},
	mounted() {
