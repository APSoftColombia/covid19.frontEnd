          ...
          <v-list-item class="pa-0">
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle class="text-truncate">
                {{ fuenteDatos && fuenteDatos.id ? 'Edición' : 'Nueva' }}
        ...
        <v-card-text>
          ...
          >
            <template v-slot:default>
              ...
              <tbody>
              <tr
                  v-for="(item, indexItem) in fuenteDatos.opciones"
                  :key="indexItem"
              >
                <td>{{ item.nombre }}</td>
                <th class="text-center">
                  <v-btn
                      ...
                      icon
                      color="error"
                      @click.stop="fuenteDatos.opciones.splice(indexItem, 1)"
                  >
        ...
        if (result) {
          if (this.fuenteDatos.opciones.length) {
            ...
            this.$store.commit('snackbar', {
              color: 'warning',
              message: 'No hay registros de opciones para ésta fuente de datos.'
            })
          }
        }
      })
