            ...
            <v-dialog v-model="dialog" persistent max-width="920">
                <v-card class="pt-3">
                    <template v-if="respuestaPersona">
                        <v-card-text class="text-center" :class="respuestaPersona.mensaje && respuestaPersona.mensaje.id === 1 ? 'green--text' : 'orange--text'">
                            ...
                            <v-list two-line class="notification-wrap">
                                ...
                                >
                                    <v-list-item-avatar class="my-1">
                                        <v-icon large color="primary">{{respuestaPersona.tamizajes[0].sexo === 'M' ? 'mdi mdi-face' : 'mdi mdi-face-woman'}}</v-icon>
                                    </v-list-item-avatar>
                            ...
                            <v-simple-table>
                                <template v-slot:default>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-left">Estado Afectación</th>
                                        ...
                                        <td>
                                            <v-list-item class="pa-0">
                                                <v-list-item-content class="pa-0">
                                                    ...
                                                    <v-list-item-subtitle>{{ item.ultimo_seguimiento ? moment(item.ultimo_seguimiento).format('DD/MM/YYYY') : '' }}</v-list-item-subtitle>
                                                </v-list-item-content>
                                            </v-list-item>
                                        </td>
                                        <td>{{ respuestaPersona.mensaje ? respuestaPersona.mensaje.id === 2 ? 'Activo - Pendiente por Asignar' : respuestaPersona.mensaje.id === 3 ? 'Activo - En Caso de Estudio' : '' : '' }}</td>
                                    </tr>
                                    </tbody>
                                </template>
                            </v-simple-table>
