                ...
                <v-list-item>
                    ...
                    <v-list-item-content class="pa-0">
                        <v-list-item-title class="grey--text fs-12 fw-normal">
                            ...
                            <h4 class="ma-0" v-else>ERP - Encuesta de Riesgo Poblacional {{tamizaje.id ? ` No. ${tamizaje.id}` : ''}}</h4>
                        </v-list-item-title>
                        <v-list-item-title v-if="tamizaje.tamizador">
                            <h6 v-if="tamizaje.tipo_tamizaje === 'telefónico'" class="mb-0">{{ `${tamizaje.llamada_entrante ? 'Llamada recibida en: ' : 'Llamada realizada desde: '}${tamizaje.tamizador.nombre}`}}</h6>
