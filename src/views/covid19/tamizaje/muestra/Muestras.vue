<template>
    <v-card flat>
        <v-toolbar dark color="error" dense>
            ...
            <template v-if="permisos.muestraCrear && editable && (!tamizaje.muestras.length || (tamizaje.muestras.length && this.tamizaje.muestras[0].resultado !== null))">
                <v-spacer></v-spacer>
                ...
                <v-col cols="12" class="pt-0" v-if="$vuetify.breakpoint.smAndUp">
                    <v-timeline dense>
                        ...
                        >
                            ...
                            <div class="pb-4">
                                <v-toolbar flat class="toolbar-muestra">
                                    ...
                                    <template v-if="permisos.muestraCrear && !muestra.path_resultado">
                                        <v-spacer></v-spacer>
                                        <v-tooltip top>
                    ...
                    <v-col cols="12" md="6" lg="4" class="mx-auto" :key="`muestra${muestraIndex}`">
                        <v-card>
                            <v-toolbar dense color="deep-orange" flat>
                                <v-toolbar-title class="white--text">Muestra {{tamizaje.muestras.length - muestraIndex}}</v-toolbar-title>
                                <template v-if="permisos.muestraCrear && !muestra.path_resultado">
                                    <v-spacer></v-spacer>
                                    <v-tooltip top>
                                        <template v-slot:activator="{on}">
