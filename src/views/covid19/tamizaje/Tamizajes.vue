                ...
                makeHeaders: [
                    ...
                    },
                    {
                        ...
                        component: {
                            ...
                            render: function (createElement, context) {
                                let texts = []
                                texts.push(createElement('c-chip', {props: {text: context.props.value.seguimientos || 0, color: 'deep-purple', tooltip: `Seguimiento${context.props.value.seguimientos === 1 ? '' : 's'}`, textColor: 'white', label: true}}))
                    ...
                    },
                    {
                        ...
                        component: {
                            ...
                            render: function (createElement, context) {
                                let texts = []
                                texts.push(createElement('c-chip', {props: {text: context.props.value.cantidad_sintomas || 0, color: 'indigo', clase: 'mr-1', tooltip: 'Síntomas', textColor: 'white', label: true}}))
                                if (context.props.value.riesgo_procedencia) texts.push(createElement('c-chip', {props: {text: 'V', color: 'green', clase: 'mr-1', tooltip: 'Antecedentes de viaje', textColor: 'white', label: true}}))
                                if (context.props.value.riesgo_ocupacional) texts.push(createElement('c-chip', {props: {text: 'O', color: 'blue', clase: 'mr-1', tooltip: 'Es trabajador de la Salud', textColor: 'white', label: true}}))
                                if (context.props.value.riesgo_contacto) texts.push(createElement('c-chip', {props: {text: 'C', color: 'purple', clase: 'mr-1', tooltip: 'Ha tenido contacto estrecho', textColor: 'white', label: true}}))
