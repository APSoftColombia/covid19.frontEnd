            ...
            <v-card>
              <v-card-text>
                ...
                <simple-table
                    ...
                    :headers="[{text:'Departamento'}, {text:'Detalle'},{text:'Variable'},
            ...
            <v-card>
              <v-card-text>
                ...
                <simple-table
                    ...
                    :headers="[{text:'Departamento'}, {text:'Detalle'},{text:'Variable'},
                    {text:'Tipo_Prueba'},{text:'Cantidad',align:'right'}]"
                    :alignNumbersRight="true"
                    :lastRowBold="true"
                ></simple-table>
              </v-card-text>
            ...
            <v-card>
              <v-card-text>
                ...
                <simple-table
                    ...
                    :headers="[{text:'Regional'}, {text:'Detalle'},{text:'Variable'},
                    {text:'Valor'},{text:'Cantidad',align:'right'}]"
                    :alignNumbersRight="true"
                    :lastRowBold="true"
                ></simple-table>
            ...
            <v-card>
              <v-card-text>
                ...
                <simple-table
                    ...
                    :headers="[{text:'Nombre'}, {text:'Detalle'},{text:'Variable'},
                    {text:'Valor'},{text:'Contactos',align:'right'}]"
                    :alignNumbersRight="true"
                    :lastRowBold="true"
                ></simple-table>
            ...
            <v-card>
              <v-card-text>
                ...
                <simple-table
                    ...
                    :headers="[{text:'Positivos_Casanare',align:'right'}, {text:'Positivos_Bogota',align:'right'},{text:'Positivos_Resto',align:'right'}]"
                    :alignNumbersRight="true"
                    :lastRowBold="true"
                ></simple-table>
              </v-card-text>
