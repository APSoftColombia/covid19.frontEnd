<template>
    <v-row v-if="encuestado">
        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">
                    ...
                    <template v-slot:append-outer class="ma-0">
                        <v-tooltip top>
                            <template v-slot:activator="{ on }">
                                <v-btn class="mb-4" color="primary" slot="activator" icon v-on="on" @click="searchAfiliadoIdentidad">
        ...
        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">
            <ValidationProvider name="primer apellido" rules="required" v-slot="{ errors, valid }">
                <v-text-field
...
<!--                    v-model="encuestado.fecha_nacimiento"-->
<!--                    :dense="false"-->
...
<!--        </v-col>-->
<!--        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">-->
<!--            <ValidationProvider name="sexo" rules="required" v-slot="{ errors, valid }">-->
<!--                <v-select-->
<!--                        label="Sexo"-->
<!--                        v-model="encuestado.sexo"-->
<!--                        :items="sexos"-->
<!--                        :error-messages="errors"-->
<!--                        outlined-->
<!--                ></v-select>-->
...
<!--                    v-model="encuestado.identidad_sexual"-->
<!--                    :items="identidadesSexuales"-->
<!--                    outlined-->
<!--            ></v-select>-->
<!--        </v-col>-->
        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">
            <ValidationProvider name="tipo de sangre" rules="required" v-slot="{ errors, valid }">
                <v-select
        ...
        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">
            <ValidationProvider name="estado civil" rules="required" v-slot="{ errors, valid }">
                <v-select
                        label="Estado civil"
        ...
        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">
            <ValidationProvider name="correo electrónico" rules="email" v-slot="{ errors, valid }">
                <v-text-field
        ...
        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">
            <ValidationProvider name="número de celular" rules="required|numeric" v-slot="{ errors, valid }">
                <v-text-field
        ...
        <v-col class="pb-0" cols="12" sm="6" md="4" lg="3">
            <ValidationProvider name="número de celular opcional" rules="numeric" v-slot="{ errors, valid }">
                <v-text-field
...
<!--            <ValidationProvider name="dirección" rules="required" v-slot="{ errors, valid }">-->
<!--                <elemento-->
<!--                        :tipo="13"-->
<!--                        label="Dirección"-->
<!--                        v-model="encuestado.direccion"-->
<!--                        :dense="false"-->
<!--                        name="dirección encuestado"-->
<!--                        rules="required"-->
<!--                ></elemento>-->
<!--            </ValidationProvider>-->
<!--        </v-col>-->
<!--        <v-col class="pb-0" cols="12" sm="12" md="6">-->
<!--            <ValidationProvider name="centro poblado" rules="required" v-slot="{ errors, valid }">-->
<!--                <v-autocomplete-->
<!--                        v-model="encuestado.centro_poblado_id"-->
<!--                        :label="(encuestado.centro_poblado_id ? '' : 'Seleccionar ') + 'Centro Poblado'"-->
<!--                        :items="centrosPoblados"-->
<!--                        :filter="filterCentrosPoblados"-->
<!--                        item-value="id"-->
<!--                        item-text="nombre"-->
<!--                        :error-messages="errors"-->
<!--                        outlined-->
<!--                        :hint="encuestado.centro_poblado_id ? `${centrosPoblados.find(x => x.id === encuestado.centro_poblado_id).municipio.nombre}, ${centrosPoblados.find(x => x.id === encuestado.centro_poblado_id).municipio.departamento.nombre}` : ''"-->
<!--                        persistent-hint-->
<!--                >-->
...
<!--                                    <v-list-item-title class="text-truncate">{{data.item.nombre}}</v-list-item-title>-->
<!--                                    <v-list-item-subtitle class="caption text-truncate">{{`${data.item.municipio.nombre}, ${data.item.municipio.departamento.nombre}`}}</v-list-item-subtitle>-->
<!--                                </v-list-item-content>-->
<!--                            </v-list-item>-->
<!--                        </v-list>-->
<!--                    </template>-->
