  ...
  >
    <template v-if="pregunta.tipo_respuesta_id === 9">
      <v-card>
        ...
        <!--                        >-->
        <!--                            <v-list-item-content>-->
        <!--                                <v-list-item-title>{{[anidado.encuestado.nombre1, anidado.encuestado.nombre2, anidado.encuestado.apellido1, anidado.encuestado.apellido2].filter(x => x).join(' ')
        }} </v-list-item-title>-->
