<template>
  ...
  >
    ...
    {{ iseccion }}
    <v-stepper-step
        :editable="encuesta.seccionGuardada === iseccion || (encuesta.seccionGuardada === 0 && iseccion === 0)"
        :complete="step > iseccion || encuesta.seccionGuardada === iseccion" :step="iseccion"
        :rules="[() => !(invalid || encuesta.seccionGuardada < iseccion)]">
      {{ seccion.nombre }}
      <small
          v-if="invalid"
