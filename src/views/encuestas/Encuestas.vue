<template>
  <v-container fluid>
    <page-title-bar title="Encuestas"/>
    <v-row>
      <template v-for="(formulario, indexForm) in formularios.filter(x => x.principal)">
        <v-col
            :key="indexForm"
            cols="12"
            sm="6"
              ...
              <v-row no-gutters>
                ...
                >
                  <v-btn
                      ...
                      block
                      large
                      :to="{name: 'ListadoEncuestas', params: {formulariouuid: formulario.uuid }}"
                  >
                    <v-icon left large>mdi-clipboard-list</v-icon>
                    Registros
                  </v-btn>
                </v-col>
                <v-col
                ...
                >
                  <v-btn
                      ...
                      block
                      large
                      :to="{name: 'DiligenciaEncuesta', params: {formulariouuid: formulario.uuid }}"
                  >
