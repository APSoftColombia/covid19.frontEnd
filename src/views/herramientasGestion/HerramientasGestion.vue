<template>
  <v-container fluid>
    ...
    <v-row>
      <v-col cols="12" v-if="permisos.herramientasGestion.lanzarAlertaActualizacion">
        <v-card>
          <v-list two-line>
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle>Lanzamiento de alerta de actualización de datos y/o desarrollo, para todos los
      ...
      <v-col cols="12" v-if="permisos.importadores.crear">
        <v-card>
          <v-list two-line>
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle>Crea y configura los elementos necesarios para un Cargador masivo de informacion
                </v-list-item-subtitle>
              </v-list-item-content>
              <v-list-item-action>
                <v-tooltip left>
