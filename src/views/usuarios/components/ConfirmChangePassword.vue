<template>
	<v-dialog v-model="dialog" max-width="500">
		<v-card class="pa-4">
			<ValidationObserver ref="formChangePassword" v-slot="{ invalid, validated, passes, validate }" tag="form"
                          autocomplete="off" @submit.prevent="submit">
				...
				<v-card-actions class="pa-0">
					<v-btn :color="colorCancel" @click="close">Cancelar</v-btn>
					<v-spacer></v-spacer>
					<v-btn :color="colorConfirm" type="submit">Aceptar</v-btn>
				</v-card-actions>
