          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="12" sm="12" md="2" lg="2">
                <v-btn color="green" class="white--text" @click="getIndicadores" block>
                  <span>Filtrar</span>
                </v-btn>
              </v-col>
            </v-row>
            ...
            <v-expansion-panels multiple popout>
                ...
                <v-expansion-panel class="mb-2">
                    ...
                    <v-expansion-panel-content>
                        <v-row>
                            <preguntas-chart :parametros="parametros"></preguntas-chart>
                        </v-row>
                    </v-expansion-panel-content>
                </v-expansion-panel>
            </v-expansion-panels>
        ...
        methods: {
          returnMunicipios(){
            ...
            getIndicadores(){
                ...
                this.loading = true
                this.axios.get(`indicadores-rcv?departamentos=${this.parametros.departamentos ? this.parametros.departamentos : []}&municipios=${this.parametros.municipios ? this.parametros.municipios : []}`).then(response => {
