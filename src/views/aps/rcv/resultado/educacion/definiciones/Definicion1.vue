  ...
  <v-col cols="12">
    ...
    >
      ...
      <v-card-text class="text-justify">
        <p>
          Los individuos de esta categoría tienen un <strong>BAJO RIESGO</strong>. Un bajo riesgo no significa "ausencia
          de riesgo".
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Limitar</strong> el consumo de <strong>alcohol</strong>, como máximo al día dos medidas en el hombre
            y una en la mujer.
          </li>
          <li>
