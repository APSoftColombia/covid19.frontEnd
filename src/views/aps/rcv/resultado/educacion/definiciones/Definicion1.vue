    ...
    <v-card outlined tile>
      ...
      <v-card-text class="text-justify">
        ...
        <ul>
          ...
          <li>
            <strong>Reducir el uso de la sal y</strong> el consumo de alimentos con alto contenido de sodio.
          </li>
          <li>
            Sumar <strong>actividad física</strong> moderada al menos 30 minutos por día.
          </li>
          <li>
            Consejo <strong>antitabaco a</strong> fumadores y no fumadores / Intervención breve según estatus / Considerar uso de fármacos.
          </li>
          <li>
