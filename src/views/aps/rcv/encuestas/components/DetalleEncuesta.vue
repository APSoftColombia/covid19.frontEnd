  ...
  <v-dialog
    ...
    >
        <v-card>
            ...
            <v-container fluid>
              <datos-afiliado :afiliado="encuesta.afiliado" :abierto="abiertoC"></datos-afiliado>
              <respuestas-encuesta class="mt-3" :encuesta="encuesta" :abierto="abiertoC"></respuestas-encuesta>
              <resultados-encuesta class="mt-3" :encuesta="encuesta" :abierto="resultadosOpenC"></resultados-encuesta>
            </v-container>
      ...
      components: {
        ...
        methods: {
            open(item = null, abierto = false, resultadosOpen = false) {
                ...
                this.resultadosOpen = resultadosOpen
                this.dialog = true
            },
            close() {
                this.dialog = false
