    ...
    methods: {
        asignar() {
          if(this.referencia) {
            ...
            this.item.hora_fallido = this.moment().format("HH:mm");
          } else {
        ...
        save() {
          this.$refs.formItem.validate().then(async result => {
            if (result) {
              ...
              itemCopia.fecha_fallido = `${itemCopia.fecha_fallido} ${itemCopia.hora_fallido}`
