  ...
  <div>
    ...
    >
      ...
      <template v-else-if="[2, 15, 3, 4, 11, 14].find(x => x === tipo)">
        <label
            class="pb-1 v-messages__message"
            style="width: 100% !important;"
        >
          {{ label }}
          <v-tooltip top v-if="descripcion">
    ...
    <template v-if="tipo === 5">
      <label
          class="pb-1 v-messages__message justify-start"
          style="width: 100% !important;"
      >
        {{ label }}
      </label>
    ...
    <div v-else-if="tipo === 10">
      ...
      >
        ...
        />
        <div class="caption error--text" style="height: 16px !important;">
