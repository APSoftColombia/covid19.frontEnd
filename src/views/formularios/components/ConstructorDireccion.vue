        ...
        <v-card>
            <v-toolbar>
                ...
                <v-list-item class="pa-0">
                    ...
                    <v-list-item-action>
                        <v-btn class="ml-4" color="warning" @click.stop="resetAll">
            ...
            <v-container fluid class="py-2">
                <v-row dense v-if="esUrbana && direccion" class="justify-center align-center">
                    ...
                    <!--                            ></v-autocomplete>-->
                    <!--                        </v-col>-->
                    <v-col class="mb-3" cols="12" sm="2" md="3">
                        <v-checkbox
                    ...
                    <!--                            ></v-autocomplete>-->
                    <!--                        </v-col>-->
                    <!--                        <v-col class="pb-0" cols="12" sm="4" md="2">-->
                    <!--                            <v-text-field-->
                    <!--                                    v-model="direccion.campo9"-->
                    <!--                                    outlined-->
                    <!--                                    dense-->
                    <!--                            ></v-text-field>-->
                    <!--                        </v-col>-->
                                    ...
                                    <th class="text-center">
                                        <v-tooltip top>
                                            <template v-slot:activator="{ on }">
                                                <v-btn class="mb-6" icon v-on="on" color="primary" @click="assignAdicional">
                ...
                <span>
                        <v-icon color="green" left>fas fa-map-signs</v-icon>
            ...
            <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn @click.stop="submitDireccion" color="primary">
