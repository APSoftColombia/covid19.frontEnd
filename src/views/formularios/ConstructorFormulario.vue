        ...
        <v-card>
            <page-title-bar :title="model && model.id ? 'Edición de Formulario' : 'Nuevo Formulario'">
                <template slot="actions">
                    <v-btn icon @click="$router.push({name: 'Formularios'})">
                        <v-icon>mdi-close</v-icon>
                    </v-btn>
                </template>
            </page-title-bar>
            <v-card-text class="ma-0 pa-0">
                <v-container fluid class="grid-list-md" v-if="model">
                    <v-row>
                    ...
                    <v-row>
                        <template v-for="(seccion, indexSeccion) in model.secciones">
                            <v-col cols="12" :key="`seccion${indexSeccion}`">
                                <seccion
                    ...
                    <v-row
                            ...
                            justify="center"
                    >
                        <v-btn color="primary" @click="addSeccion">
